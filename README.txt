...
# There was an error: identifier "siginfo_t" is undefined
# This error seems to happen on the crescent cluster on older versions of CMake and GCC 
    # to solve this I followed the thread posted here: https://github.com/KarypisLab/GKlib/issues/13
        # I commented the lines in the file as instructed in the link above 
        # The lines to be commented in the files are given here: https://github.com/KarypisLab/GKlib/commit/a7f8172703cf6e999dd0710eb279bba513da4fec#diff-430d86fdb6c4a558ab0f1b6648bbfae1720e8bde84f026e95a52740014752040R17 
        # After commenting you have to build GKlib manually with the commands from the .sh files manually after which you can just run the rest of the .sh script to build HemoCell
