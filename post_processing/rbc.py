...
vlc = ((9.926793152623878-6.978333784100385)*2)*(31.5*10**(-6))**(3)

# Volume of the smaller child vessel
vsc = ((6.978333784100385-5.828145778622223)*2)*(31.5*10**(-6))**(3)
...
vel_mag_bifur_case0 = []
y_dist_bifur_case0 = []
mean_vel_mag_ratio_spv_case0 = []
mean_vel_mag_ratio_lpv_case0 = []
#
for file in files0:
    ...
    condition_lv0 = (x0 > 208.215e-6) & (x0 < 506.835e-6) & (y0 > 64.18e-6) # larger child vessel only
    condition_sv0 = (x0 > 208.215e-6) & (x0 < 506.835e-6) & (y0 < 64.18e-6) # smaller child vessel only
    condition_bifur0 = (x0 > 200e-6) & (x0 < 356.1075e-6) # bifurcation-region-one-side
    #
    ...
    #
    hct_total0.append(hct_total0_single*100)
    ...
    mean_vel_mag_ratio_lsv_case0.append(mean_vel_mag_ratio_lsv_single_case0)
    #
    ...
    #
    vel_mag_bifur_0 = vel_mag[condition_bifur0]
    vel_mag_bifur_case0.append(vel_mag_bifur_0)
    y_dist_bifur_single_case0 = y0[condition_bifur0]
    y_dist_bifur_case0.append(y_dist_bifur_single_case0)
    #
    mean_vel_mag_ratio_lpv_single_case0 = mean_vel_mag_lv_single_case0/mean_vel_mag_pv_single_case0
    mean_vel_mag_ratio_lpv_case0.append(mean_vel_mag_ratio_lpv_single_case0)
    mean_vel_mag_ratio_spv_single_case0 = mean_vel_mag_sv_single_case0/mean_vel_mag_pv_single_case0
    mean_vel_mag_ratio_spv_case0.append(mean_vel_mag_ratio_spv_single_case0)
    #
    #### TRACKING RBC's
    base_cell_id0 = np.array(csv0["baseCellId"])
#
...
#
all_vel_mag_bifur_case0 = np.concatenate(vel_mag_bifur_case0)
all_y_dist_bifur_case0 = np.concatenate(y_dist_bifur_case0)
# 
################ End of Baseline #############
#
################## Case1##################
...
vel_mag_bifur_case1 = []
y_dist_bifur_case1 = []
mean_vel_mag_ratio_spv_case1 = []
mean_vel_mag_ratio_lpv_case1 = []
#
for file in files1:
    ...
    condition_lv1 = (x1 > 208.215e-6) & (x1 < 506.835e-6) & (y1 > 64.18e-6)
    condition_sv1 = (x1 > 208.215e-6) & (x1 < 506.835e-6) & (y1 < 64.18e-6)
    condition_bifur1 = (x1 > 160.65e-6) & (x1 < 356.1075e-6)
    #
    ...
    #
    hct_total1.append(hct_total1_single*100)
    ...
    mean_vel_mag_ratio_lsv_case1.append(mean_vel_mag_ratio_lsv_single_case1)
    #
    ...
    #
    vel_mag_bifur_1 = vel_mag[condition_bifur1]
    vel_mag_bifur_case1.append(vel_mag_bifur_1)
    y_dist_bifur_single_case1 = y1[condition_bifur1]
    y_dist_bifur_case1.append(y_dist_bifur_single_case1)
    #
    mean_vel_mag_ratio_lpv_single_case1 = mean_vel_mag_lv_single_case1/mean_vel_mag_pv_single_case1
    mean_vel_mag_ratio_lpv_case1.append(mean_vel_mag_ratio_lpv_single_case1)
    mean_vel_mag_ratio_spv_single_case1 = mean_vel_mag_sv_single_case1/mean_vel_mag_pv_single_case1
    mean_vel_mag_ratio_spv_case1.append(mean_vel_mag_ratio_spv_single_case1)
#
...
#
all_vel_mag_bifur_case1 = np.concatenate(vel_mag_bifur_case1)
all_y_dist_bifur_case1 = np.concatenate(y_dist_bifur_case1)
#
################ End of Case1 #############
#
################## Case2 ##################
...
vel_mag_bifur_case2 = []
y_dist_bifur_case2 = []
mean_vel_mag_ratio_spv_case2 = []
mean_vel_mag_ratio_lpv_case2 = []
#
for file in files2:
    ...
    condition_lv2 = (x2 > 208.215e-6) & (x2 < 506.835e-6) & (y2 > 64.18e-6)
    condition_sv2 = (x2 > 208.215e-6) & (x2 < 506.835e-6) & (y2 < 64.18e-6)
    condition_bifur2 = (x2 > 160.65e-6) & (x2 < 356.1075e-6)
    #
    ...
    #
    hct_total2.append(hct_total2_single*100)
    ...
    mean_vel_mag_ratio_lsv_case2.append(mean_vel_mag_ratio_lsv_single_case2)
    #
    ...
    #
    vel_mag_bifur_2 = vel_mag[condition_bifur2]
    vel_mag_bifur_case2.append(vel_mag_bifur_2)
    y_dist_bifur_single_case2 = y2[condition_bifur2]
    y_dist_bifur_case2.append(y_dist_bifur_single_case2)
    #
    mean_vel_mag_ratio_lpv_single_case2 = mean_vel_mag_lv_single_case2/mean_vel_mag_pv_single_case2
    mean_vel_mag_ratio_lpv_case2.append(mean_vel_mag_ratio_lpv_single_case2)
    mean_vel_mag_ratio_spv_single_case2 = mean_vel_mag_sv_single_case2/mean_vel_mag_pv_single_case2
    mean_vel_mag_ratio_spv_case2.append(mean_vel_mag_ratio_spv_single_case2)
#
...
#
all_vel_mag_bifur_case2 = np.concatenate(vel_mag_bifur_case2)
all_y_dist_bifur_case2 = np.concatenate(y_dist_bifur_case2)
#
################ End of Case2 #############
#
################## Case3 ##################
...
vel_mag_bifur_case3 = []
y_dist_bifur_case3 = []
mean_vel_mag_ratio_lpv_case3 = []
mean_vel_mag_ratio_spv_case3 = []
 #
for file in files3:
    ...
    condition_lv3 = (x3 > 208.215e-6) & (x3 < 506.835e-6) & (y3 > 64.18e-6)
    condition_sv3 = (x3 > 208.215e-6) & (x3 < 506.835e-6) & (y3 < 64.18e-6)
    condition_bifur3 = (x3 > 160.65e-6) & (x3 < 356.1075e-6)
    #
    ...
    #
    hct_total3.append(hct_total3_single*100)
    ...
    mean_vel_mag_ratio_lsv_case3.append(mean_vel_mag_ratio_lsv_single_case3)
    #
    ...
    #
    vel_mag_bifur_3 = vel_mag[condition_bifur3]
    vel_mag_bifur_case3.append(vel_mag_bifur_3)
    y_dist_bifur_single_case3 = y3[condition_bifur3]
    y_dist_bifur_case3.append(y_dist_bifur_single_case3)
    #
    mean_vel_mag_ratio_lpv_single_case3 = mean_vel_mag_lv_single_case3/mean_vel_mag_pv_single_case3
    mean_vel_mag_ratio_lpv_case3.append(mean_vel_mag_ratio_lpv_single_case3)
    mean_vel_mag_ratio_spv_single_case3 = mean_vel_mag_sv_single_case3/mean_vel_mag_pv_single_case3
    mean_vel_mag_ratio_spv_case3.append(mean_vel_mag_ratio_spv_single_case3)
#
...
#
all_vel_mag_bifur_case3 = np.concatenate(vel_mag_bifur_case3)
all_y_dist_bifur_case3 = np.concatenate(y_dist_bifur_case3)
#
################ End of Case3 #############
#
################## Case4 ##################
...
vel_mag_bifur_case4 = []
y_dist_bifur_case4 = []
mean_vel_mag_ratio_lpv_case4 = []
mean_vel_mag_ratio_spv_case4 = []
#
for file in files4:
    ...
    condition_lv4 = (x4 > 208.215e-6) & (x4 < 506.835e-6) & (y4 > 64.18e-6)
    condition_sv4 = (x4 > 208.215e-6) & (x4 < 506.835e-6) & (y4 < 64.18e-6)
    condition_bifur4 = (x4 > 200e-6) & (x4 < 356.1075e-6)
    ...
    #
    hct_total4.append(hct_total4_single*100)
    ...
    mean_vel_mag_ratio_lsv_case4.append(mean_vel_mag_ratio_lsv_single_case4)
    #
    ...
    #
    vel_mag_bifur_4 = vel_mag[condition_bifur4]
    vel_mag_bifur_case4.append(vel_mag_bifur_4)
    y_dist_bifur_single_case4 = y4[condition_bifur4]
    y_dist_bifur_case4.append(y_dist_bifur_single_case4)
    #
    mean_vel_mag_ratio_lpv_single_case4 = mean_vel_mag_lv_single_case4/mean_vel_mag_pv_single_case4
    mean_vel_mag_ratio_lpv_case4.append(mean_vel_mag_ratio_lpv_single_case4)
    mean_vel_mag_ratio_spv_single_case4 = mean_vel_mag_sv_single_case4/mean_vel_mag_pv_single_case4
    mean_vel_mag_ratio_spv_case4.append(mean_vel_mag_ratio_spv_single_case4)
#
...
#
all_vel_mag_bifur_case4 = np.concatenate(vel_mag_bifur_case4)
all_y_dist_bifur_case4 = np.concatenate(y_dist_bifur_case4)
#
################ End of Case4 #############
#
...
### BIFURCATION
mean_value_vel_mag_bifur_case0 = np.mean(all_vel_mag_bifur_case0*1000)
std_dev_vel_mag_bifur_case0 = np.std(all_vel_mag_bifur_case0*1000)
#y-dist
mean_value_y_dist_case0 = np.mean(all_y_dist_bifur_case0)
std_dev_y_dist_case0 = np.std(all_y_dist_bifur_case0)
############ END OF BASELINE ############
#
############### CASE1 ##############
### TOTAL DOMAIN
...
### BIFURCATION
mean_value_vel_mag_bifur_case1 = np.mean(all_vel_mag_bifur_case1*1000)
std_dev_vel_mag_bifur_case1 = np.std(all_vel_mag_bifur_case1*1000)
#y-dist
mean_value_y_dist_case1 = np.mean(all_y_dist_bifur_case1)
std_dev_y_dist_case1 = np.std(all_y_dist_bifur_case1)
############ END OF CASE1 ############
#
############### CASE2 ##############
### TOTAL DOMAIN
...
### BIFURCATION
mean_value_vel_mag_bifur_case2 = np.mean(all_vel_mag_bifur_case2*1000)
std_dev_vel_mag_bifur_case2 = np.std(all_vel_mag_bifur_case2*1000)
#y-dist
mean_value_y_dist_case2 = np.mean(all_y_dist_bifur_case2)
std_dev_y_dist_case2 = np.std(all_y_dist_bifur_case2)
############ END OF CASE2 ############
#
############### CASE3 ##############
### TOTAL DOMAIN
...
### BIFURCATION
mean_value_vel_mag_bifur_case3 = np.mean(all_vel_mag_bifur_case3*1000)
std_dev_vel_mag_bifur_case3 = np.std(all_vel_mag_bifur_case3*1000)
############ END OF CASE3 ############
#
############### CASE4 ##############
### TOTAL DOMAIN
...
### BIFURCATION
#Velocity
mean_value_vel_mag_bifur_case4 = np.mean(all_vel_mag_bifur_case4*1000)
std_dev_vel_mag_bifur_case4 = np.std(all_vel_mag_bifur_case4*1000)
#y-dist
mean_value_y_dist_case4 = np.mean(all_y_dist_bifur_case4)
std_dev_y_dist_case4 = np.std(all_y_dist_bifur_case4)
############ END OF CASE4 ############
#
...
plt.title("Larger Child Vessel to Parent Vessel", fontdict=font)
plt.grid(True)
plt.legend([label0,label1, label2, label3, label4], fontsize = font['size'])
plt.tight_layout()
#
...
plt.xlabel('Time (s)', fontdict=font)
plt.ylabel('Hct Ratio', fontdict= font)
plt.title("Smaller Child Vessel to Parent Vessel", fontdict=font)
plt.grid(True)
plt.legend([label0,label1, label2, label3, label4], fontsize = font['size'])
plt.tight_layout()
#
...
# # Plot the histogram
# plt.figure(figsize=(14, 7))
# plt.hist(all_vel_mag_bifur_case1 * 1000, bins=25, alpha = 0.5, label=label1)
# plt.hist(all_vel_mag_bifur_case0 * 1000, bins=25, alpha = 0.5, label=label0)
# # STAT MOMENTS FOR BASELINE
# plt.axvline(mean_value_vel_mag_bifur_case0, color='red', linestyle='dashed', linewidth=1, label='Mean - Baseline')
# plt.axvline(mean_value_vel_mag_bifur_case0 + std_dev_vel_mag_bifur_case0, color='green', linestyle='dashed', linewidth=1, label='Mean + Std Dev - Basline')
# plt.axvline(mean_value_vel_mag_bifur_case0 - std_dev_vel_mag_bifur_case0, color='green', linestyle='dashed', linewidth=1, label='Mean - Std Dev - Baseline')
# # plt.axvline(data_skewness_vel_mag_case0, color='purple', linestyle='dashed', linewidth=2, label='Skewness - Baseline')
# # plt.axvline(data_kurtosis_vel_mag_case0, color='orange', linestyle='dashed', linewidth=2, label='Kurtosis - Baseline')
# #
# # STAT MOMENTS FOR CASE 1
# plt.axvline(mean_value_vel_mag_bifur_case1, color='yellow', linestyle='dotted', linewidth=1, label='Mean - Case1')
# plt.axvline(mean_value_vel_mag_bifur_case1 + std_dev_vel_mag_bifur_case1, color='purple', linestyle='dotted', linewidth=1, label='Mean + Std Dev - Case1')
# plt.axvline(mean_value_vel_mag_bifur_case1 - std_dev_vel_mag_bifur_case1, color='blue', linestyle='dotted', linewidth=1, label='Mean - Std Dev - Case1')
# # plt.axvline(data_skewness_vel_mag_case1, color='purple', linestyle='dashed', linewidth=2, label='Skewness - Case1')
# # plt.axvline(data_kurtosis_vel_mag_case1, color='orange', linestyle='dashed', linewidth=2, label='Kurtosis - Case1')
# #
# plt.xlabel('RBC Velocity Magnitude (mm/s)', fontdict=font)
# plt.ylabel('Frequency', fontdict=font)
# plt.title('Baseline vs Case1 - Bifurcation Region', fontdict=font)
# plt.xticks(fontsize=font['size'])
# plt.yticks(fontsize=font['size']) 
# plt.legend()
# plt.tight_layout()
# #
# plt.savefig(output_dir + "histogram_density_plots/hist_bifur_bv1" + ".png", dpi = 300)
# #
# plt.show()

# # Plot the density plot
# plt.figure(figsize=(14, 7))
# sns.kdeplot(all_vel_mag_bifur_case0 * 1000, alpha = 0.5, label=label0, color='blue', fill=True)
# sns.kdeplot(all_vel_mag_bifur_case1 * 1000, alpha = 0.5, label=label1, color='green', fill=True)
# # STAT MOMENTS FOR BASELINE
# plt.axvline(mean_value_vel_mag_bifur_case0, color='red', linestyle='dashed', linewidth=1, label='Mean - Baseline')
# plt.axvline(mean_value_vel_mag_bifur_case0 + std_dev_vel_mag_bifur_case0, color='green', linestyle='dashed', linewidth=1, label='Mean + Std Dev - Basline')
# plt.axvline(mean_value_vel_mag_bifur_case0 - std_dev_vel_mag_bifur_case0, color='green', linestyle='dashed', linewidth=1, label='Mean - Std Dev - Baseline')
...
# plt.tight_layout()
# #
# plt.savefig(output_dir + "histogram_density_plots/dens_bifur_bv1" + ".png", dpi = 300)
# #
# plt.show()
...
# # Plot the histogram
# plt.figure(figsize=(14, 7))
# plt.hist(all_vel_mag_bifur_case4 * 1000, bins=25, alpha = 0.5, label=label4)
# plt.hist(all_vel_mag_bifur_case0 * 1000, bins=25, alpha = 0.5, label=label0)
# # STAT MOMENTS FOR BASELINE
# plt.axvline(mean_value_vel_mag_bifur_case0, color='red', linestyle='dashed', linewidth=1, label='Mean - Baseline')
# plt.axvline(mean_value_vel_mag_bifur_case0 + std_dev_vel_mag_bifur_case0, color='green', linestyle='dashed', linewidth=1, label='Mean + Std Dev - Basline')
...
# #
# # STAT MOMENTS FOR CASE 4
# plt.axvline(mean_value_vel_mag_bifur_case4, color='yellow', linestyle='dotted', linewidth=1, label='Mean - Case4')
# plt.axvline(mean_value_vel_mag_bifur_case4 + std_dev_vel_mag_bifur_case4, color='purple', linestyle='dotted', linewidth=1, label='Mean + Std Dev - Case4')
# plt.axvline(mean_value_vel_mag_bifur_case4 - std_dev_vel_mag_bifur_case4, color='blue', linestyle='dotted', linewidth=1, label='Mean - Std Dev - Case4')
# # plt.axvline(data_skewness_vel_mag_case1, color='purple', linestyle='dashed', linewidth=2, label='Skewness - Case1')
# # plt.axvline(data_kurtosis_vel_mag_case1, color='orange', linestyle='dashed', linewidth=2, label='Kurtosis - Case1')
# #
# plt.xlabel('RBC Velocity Magnitude (mm/s)', fontdict=font)
# plt.ylabel('Frequency', fontdict=font)
# plt.title('Baseline vs Case4 - Bifurcation Region', fontdict=font)
# plt.xticks(fontsize=font['size'])
# plt.yticks(fontsize=font['size']) 
# plt.legend()
# plt.tight_layout()
# #
# plt.savefig(output_dir + "histogram_density_plots/hist_bifur_bv4" + ".png", dpi = 300)
# #
# plt.show()
...
# plt.figure(figsize=(14, 7))
# sns.kdeplot(all_vel_mag_bifur_case0 * 1000, alpha = 0.5, label=label0, color='blue', fill=True)
# sns.kdeplot(all_vel_mag_bifur_case4 * 1000, alpha = 0.5, label=label4, color='green', fill=True)
# # STAT MOMENTS FOR BASELINE
# plt.axvline(mean_value_vel_mag_bifur_case0, color='red', linestyle='dashed', linewidth=1, label='Mean - Baseline')
# plt.axvline(mean_value_vel_mag_bifur_case0 + std_dev_vel_mag_bifur_case0, color='green', linestyle='dashed', linewidth=1, label='Mean + Std Dev - Basline')
# plt.axvline(mean_value_vel_mag_bifur_case0 - std_dev_vel_mag_bifur_case0, color='green', linestyle='dashed', linewidth=1, label='Mean - Std Dev - Baseline')
...
# plt.tight_layout()
# #
# plt.savefig(output_dir + "histogram_density_plots/dens_bifur_bv4" + ".png", dpi = 300)
# #
# plt.show()
...
# # Plot the histogram
# plt.figure(figsize=(14, 7))
# plt.hist(all_y_dist_bifur_case0 * 1e6, bins=25, alpha = 0.5, label=label0)
# plt.hist(all_y_dist_bifur_case4 * 1e6, bins=25, alpha = 0.5, label=label4)
# # # STAT MOMENTS FOR BASELINE
# # plt.axvline(mean_value_vel_mag_pv_case0, color='red', linestyle='dashed', linewidth=1, label='Mean - Baseline')
# # plt.axvline(mean_value_vel_mag_pv_case0 + std_dev_vel_mag_pv_case0, color='green', linestyle='dashed', linewidth=1, label='Mean + Std Dev - Basline')
# # plt.axvline(mean_value_vel_mag_pv_case0 - std_dev_vel_mag_pv_case0, color='green', linestyle='dashed', linewidth=1, label='Mean - Std Dev - Baseline')
...
# plt.tight_layout()
# #
# plt.savefig(output_dir + "y_distribution/hist_y_bifur_bv4" + ".png", dpi = 300)
# #
# plt.show()

# # Plot the density plot
# plt.figure(figsize=(14, 7))
# sns.kdeplot(all_y_dist_bifur_case0 * 1e6, alpha = 0.5, label=label0, color='blue', fill=True)
# sns.kdeplot(all_y_dist_bifur_case4 * 1e6, alpha = 0.5, label=label4, color='green', fill=True)
# # # STAT MOMENTS FOR BASELINE
# # plt.axvline(mean_value_y_dist_case0, color='red', linestyle='dashed', linewidth=1, label='Mean - Baseline')
# # plt.axvline(mean_value_y_dist_case0 + std_dev_y_dist_case0, color='green', linestyle='dashed', linewidth=1, label='Mean + Std Dev - Basline')
# # plt.axvline(mean_value_y_dist_case0 - std_dev_y_dist_case0, color='green', linestyle='dashed', linewidth=1, label='Mean - Std Dev - Baseline')
# # # plt.axvline(data_skewness_vel_mag_case0, color='purple', linestyle='dashed', linewidth=2, label='Skewness - Baseline')
# # # plt.axvline(data_kurtosis_vel_mag_case0, color='orange', linestyle='dashed', linewidth=2, label='Kurtosis - Baseline')
# # #
# # # STAT MOMENTS FOR CASE 4
# # plt.axvline(mean_value_y_dist_case4, color='yellow', linestyle='dotted', linewidth=1, label='Mean - Case4')
# # plt.axvline(mean_value_y_dist_case4 + std_dev_y_dist_case4, color='purple', linestyle='dotted', linewidth=1, label='Mean + Std Dev - Case4')
# # plt.axvline(mean_value_y_dist_case4 - std_dev_y_dist_case4, color='blue', linestyle='dotted', linewidth=1, label='Mean - Std Dev - Case4')
# # # plt.axvline(data_skewness_vel_mag_case1, color='purple', linestyle='dashed', linewidth=2, label='Skewness - Case1')
# # # plt.axvline(data_kurtosis_vel_mag_case1, color='orange', linestyle='dashed', linewidth=2, label='Kurtosis - Case1')
# # #
# plt.title("Baseline vs Case4 - Bifurcation Region", fontdict=font)
...
# plt.tight_layout()
# #
# plt.savefig(output_dir + "y_distribution/dens_y_bifur_bv4" + ".png", dpi = 300)
# #
# plt.show()
# ######################## end of Baseline vs case4 ##############

#### all cases - smaller vessel

# # Plot the density plot
# plt.figure(figsize=(14, 7))
# sns.kdeplot(all_y_dist_sv_case0 * 1e6, alpha = 0.5, label=label0, color='blue', fill=True)
# sns.kdeplot(all_y_dist_sv_case1 * 1e6, alpha = 0.5, label=label1, color='green', fill=True)
# sns.kdeplot(all_y_dist_sv_case2 * 1e6, alpha = 0.5, label=label2, color='red', fill=True)
# sns.kdeplot(all_y_dist_sv_case3 * 1e6, alpha = 0.5, label=label3, color='yellow', fill=True)
# sns.kdeplot(all_y_dist_sv_case4 * 1e6, alpha = 0.5, label=label4, color='grey', fill=True)
# # # STAT MOMENTS FOR BASELINE
# # plt.axvline(mean_value_vel_mag_pv_case0, color='red', linestyle='dashed', linewidth=1, label='Mean - Baseline')
# # plt.axvline(mean_value_vel_mag_pv_case0 + std_dev_vel_mag_pv_case0, color='green', linestyle='dashed', linewidth=1, label='Mean + Std Dev - Basline')
# # plt.axvline(mean_value_vel_mag_pv_case0 - std_dev_vel_mag_pv_case0, color='green', linestyle='dashed', linewidth=1, label='Mean - Std Dev - Baseline')
...
# plt.tight_layout()
# #
# plt.savefig(output_dir + "y_distribution/dens_y_sv_all_cases" + ".png", dpi = 300)
# #
# plt.show()
#
#
# #### all cases - bifurcation region #######

# # Plot the density plot
# plt.figure(figsize=(14, 7))
# sns.kdeplot(all_y_dist_bifur_case0 * 1e6, alpha = 0.5, label=label0, color='blue', fill=True)
# sns.kdeplot(all_y_dist_bifur_case1 * 1e6, alpha = 0.5, label=label1, color='green', fill=True)
# sns.kdeplot(all_y_dist_bifur_case2 * 1e6, alpha = 0.5, label=label2, color='red', fill=True)
# sns.kdeplot(all_y_dist_bifur_case3 * 1e6, alpha = 0.5, label=label3, color='yellow', fill=True)
# sns.kdeplot(all_y_dist_bifur_case4 * 1e6, alpha = 0.5, label=label4, color='grey', fill=True)
# # # STAT MOMENTS FOR BASELINE
# # plt.axvline(mean_value_y_dist_case0, color='red', linestyle='dashed', linewidth=1, label='Mean - Baseline')
# # plt.axvline(mean_value_y_dist_case0 + std_dev_y_dist_case0, color='green', linestyle='dashed', linewidth=1, label='Mean + Std Dev - Basline')
# # plt.axvline(mean_value_y_dist_case0 - std_dev_y_dist_case0, color='green', linestyle='dashed', linewidth=1, label='Mean - Std Dev - Baseline')
...
# plt.title("Bifurcation Region", fontdict=font)
# plt.xlabel("RBC y Distribution (μm)", fontdict=font)
# plt.ylabel("Density", fontdict=font)
# plt.xticks(fontsize=font['size'])
# plt.yticks(fontsize=font['size']) 
...
# plt.tight_layout()
# #
# plt.savefig(output_dir + "y_distribution/dens_y_bifur_all_cases" + ".png", dpi = 300)
# #
# plt.show()
...
# plt.ylabel("Velocity Magnitude (mm/s) ", fontdict=font)
# plt.xticks(fontsize=font['size'])
# plt.yticks(fontsize=font['size']) 
...
# plt.show()
# #
# ## PLOTS - LARGER AND SMALLER CHILD VESSEL RATIO
# #   
# plt.figure(figsize=(14,7))
# plt.plot(value0[1:], mean_vel_mag_ratio_lsv_case0[1:],'k-', label=label0)
# plt.plot(value1[1:], mean_vel_mag_ratio_lsv_case1[1:],'.-',color='#9467bd', label=label1)
# plt.plot(value2[1:], mean_vel_mag_ratio_lsv_case2[1:],'g--', label=label2)
# plt.plot(value3[1:], mean_vel_mag_ratio_lsv_case3[1:],'b:', label=label3)
# plt.plot(value4[1:], mean_vel_mag_ratio_lsv_case4[1:],'r', label=label4)
# plt.xticks(fontsize=font['size'])
# plt.yticks(fontsize=font['size'])  
# plt.xlabel('Time (s)', fontdict=font)
# plt.ylabel('Mean Velocity Magnitude Ratio', fontdict= font)
# plt.title("Larger to Smaller Child Vessel", fontdict=font)
# plt.grid(True)
# plt.legend([label0,label1, label2, label3, label4],fontsize = font['size'])
# plt.tight_layout()
# #
# plt.savefig(output_dir + "velocity_plots/ratio_lsv_vel_mag" + ".png", dpi = 300)
# #
# plt.show()
#

# ## PLOTS - LARGER AND PARENT VESSEL RATIO
# #   
# plt.figure(figsize=(14,7))
# plt.plot(value0[1:], mean_vel_mag_ratio_lpv_case0[1:],'k-', label=label0)
# plt.plot(value1[1:], mean_vel_mag_ratio_lpv_case1[1:],'.-',color='#9467bd', label=label1)
# plt.plot(value2[1:], mean_vel_mag_ratio_lpv_case2[1:],'g--', label=label2)
# plt.plot(value3[1:], mean_vel_mag_ratio_lpv_case3[1:],'b:', label=label3)
# plt.plot(value4[1:], mean_vel_mag_ratio_lpv_case4[1:],'r', label=label4)
# plt.xticks(fontsize=font['size'])
# plt.yticks(fontsize=font['size'])  
# plt.xlabel('Time (s)', fontdict=font)
# plt.ylabel('Mean Velocity Magnitude Ratio', fontdict= font)
# plt.title("Larger child to Parent Vessels", fontdict=font)
# plt.grid(True)
# plt.legend([label0,label1, label2, label3, label4],fontsize = font['size'])
# plt.tight_layout()
# #
# plt.savefig(output_dir + "velocity_plots/ratio_lpv_vel_mag" + ".png", dpi = 300)
# #
# plt.show()

# ## PLOTS - SMALLER AND PARENT VESSEL RATIO
# #   
# plt.figure(figsize=(14,7))
# plt.plot(value0[1:], mean_vel_mag_ratio_spv_case0[1:],'k-', label=label0)
# plt.plot(value1[1:], mean_vel_mag_ratio_spv_case1[1:],'.-',color='#9467bd', label=label1)
# plt.plot(value2[1:], mean_vel_mag_ratio_spv_case2[1:],'g--', label=label2)
# plt.plot(value3[1:], mean_vel_mag_ratio_spv_case3[1:],'b:', label=label3)
# plt.plot(value4[1:], mean_vel_mag_ratio_spv_case4[1:],'r', label=label4)
# plt.xticks(fontsize=font['size'])
# plt.yticks(fontsize=font['size'])  
# plt.xlabel('Time (s)', fontdict=font)
# plt.ylabel('Mean Velocity Magnitude Ratio', fontdict= font)
# plt.title("Smaller child to Parent Vessels", fontdict=font)
# plt.grid(True)
# plt.legend([label0,label1, label2, label3, label4],fontsize = font['size'])
# plt.tight_layout()
# #
# plt.savefig(output_dir + "velocity_plots/ratio_spv_vel_mag" + ".png", dpi = 300)
# #
# plt.show()
