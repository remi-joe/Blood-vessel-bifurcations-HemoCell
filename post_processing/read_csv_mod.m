function [u_ratio1,u_ratio2,Ht_ratio1,Ht_ratio2,Ht_mean,Ht_std]=read_csv_mod(max_iter,step_size,Diameter,Geometry,Haematocrit)
dbstop if error
    ...
    line_number=0;
    first_line=55;
    path = strcat("/home/remi/irp/simulation_files/case_files/D", num2str(Diameter, '%.1f'), "_", num2str(Geometry), "_", num2str(Haematocrit), "/output_0/log/logfile");
    fid=fopen(path);
    while ~feof(fid)
    ...
    file_name = strcat("/home/remi/irp/simulation_files/case_files/D", num2str(Diameter, '%.1f'), "_", num2str(Geometry), "_", num2str(Haematocrit), "/output_0/csv/RBC.", num2str(0, '%.12d'), ".csv");
    ...
    for i=2:total_record
        file_name = strcat("/home/remi/irp/simulation_files/case_files/D", num2str(Diameter, '%.1f'), "_", num2str(Geometry), "_", num2str(Haematocrit), "/output_0/csv/RBC.", num2str((i-1)*step_size, '%.12d'), ".csv");
        temp=csvread(file_name,1,0);
...
%     Ht_std=std(Ht_global);
    ...
    title(strcat("D=", num2str(Diameter), "um ", "H", num2str(Haematocrit)))
    figure(2)
